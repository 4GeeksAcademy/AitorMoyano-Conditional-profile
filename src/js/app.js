...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1>
          ${variables.name ? variables.name : "Sin nombre"} 
    ${variables.lastName ? variables.lastName : "Sin apellido"}
    </h1>

          <h2>${variables.role ? variables.role : "Sin roll"}</h2>
          <h3>${variables.city ? variables.city : "Sin ciudad"}, ${
    variables.country ? variables.country : "Sin pais"
  }</h3>
